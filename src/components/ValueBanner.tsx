    ...
    <section className="banner-section" aria-label="What Kiwi is">
      <Reveal as="div" className="container banner-content" stagger>
        <p className="banner-positioning">
          A copilot suggests code you then have to write. A sandbox vendor rents you a box you then have to fill. <span className="text-gradient">Kiwi takes the task through to a pull request, inside a boundary you set — and it doesn&rsquo;t stop talking when review starts.</span>
        </p>
